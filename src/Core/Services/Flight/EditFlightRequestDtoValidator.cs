...
{
     class EditFlightRequestDtoValidator:AbstractValidator<EditFlightDto>
    {
        public EditFlightRequestDtoValidator()
        {
            RuleFor(f => f.FlightId)
            .NotNull()
            .WithMessage("Flight seçilmelidir.");
        ...
        .WithMessage("Airplane seçilmelidir.");
            ...
            RuleFor(f => f.BusinessPrice)
                 .NotNull()
                .WithMessage("Business Price bos olmamalidir");
